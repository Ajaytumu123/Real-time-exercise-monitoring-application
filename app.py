...
@st.cache_resource()
def build_model(HIDDEN_UNITS=256, sequence_length=29, num_input_values=33*4, num_classes=3):
    """
    ...
    ## Load Model Weights
    load_dir = "/Users/tsaiajay/Desktop/CP575/Exercise_Recognition_AI-main/LSTM_Attention_new.h5"  
